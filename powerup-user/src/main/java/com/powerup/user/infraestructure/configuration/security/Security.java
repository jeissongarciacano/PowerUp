...
public class Security {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .antMatchers("/api/v1/user/administrador/**").hasAuthority("Administrador")
                .antMatchers("/api/v1/user/propietario/**").hasAuthority("Propietario")
                .antMatchers("/api/v1/square/administrador/**").hasAuthority("Administrador")
