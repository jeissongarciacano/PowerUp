...
import com.powerup.user.infraestructure.configuration.security.auth.DetailsUser;
import com.powerup.user.infraestructure.configuration.security.auth.IUserDetailsMapper;
